...
custom_edit_url: https://github.com/gojutin/www.tsx.guide/blob/master/docs/site/contributing.mdx
...
> Please review the [Code of Conduct](./code-of-conduct.mdx) before you make any contributions.

## 1. File an Issue

If you don't feel like going in and making any changes to the code yourself, you can [submit an issue on GitHub].
...
The source code is conceptually made up of two parts:

1. **The website**

This site is built with [Docusaurus 2] and has few customizations beyond the defaults. The custom components are built using [styled-components](https://styled-components.com/) and [Infima](https://facebookincubator.github.io/infima/docs/getting-started/introduction).

There are a couple cheatsheets in the repo that are helpful when working on this project or creating documentation pages:

- [INFIMA_CHEATSHEET]- details most of the css utilities that the library provides.
- [MDX_CHEATSHEET]- details most of MDX features that are provided by Docusaurus.
...
title: Contributing
sidebar_label: Contributing
custom_edit_url: https://github.com/gojutin/www.tsx.guide/blob/master/docs/introduction/contributing.mdx
description: Contributing to the tsx.guide documentation website.
keywords:
  - typescript
  - react
...
Copied from the [Docusaurus Docs]:
...
[submit an issue on github]: https://github.com/gojutin/www.tsx.guide/issues
[docusaurus 2]: https://v2.docusaurus.io/
[infima_cheatsheet]: https://github.com/gojutin/www.tsx.guide/blob/master/INFIMA_CHEATSHEET.md
[mdx_cheatsheet]: https://github.com/gojutin/www.tsx.guide/blob/master/MDX_CHEATSHEET.md
[docusaurus docs]: https://v2.docusaurus.io/docs/markdown-features
