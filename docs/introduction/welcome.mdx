...
custom_edit_url: https://github.com/gojutin/www.tsx.guide/blob/master/docs/introduction/welcome.mdx
...
<div className="hero hero--dark padding--md margin-bottom--md">
  <p className="margin--sm padding--xs text--semibold">
